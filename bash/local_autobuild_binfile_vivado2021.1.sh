...
# $3 is upload folder from your task build folder
# $4 is result folder to the task folder
...
# Let vivado run
export XILINXD_LICENSE_FILE=/opt/flexlm/Xilinx.lic&&/tools/Xilinx/Vivado/2021.1/bin/vivado -mode tcl -source /home/$1/.autobuild_script/create_project_full_run.tcl;exit;
